...
const addUser = (class_id, role, email, firstName, lastName) => new Promise((resolve, reject) => {
  pool.getConnection((err, db) => {
    const query = 'INSERT INTO users (user_role, email, password, first_name, last_name, date_of_birth, class_id) '
...
const addClass = () => new Promise((resolve, reject) => {
  pool.getConnection((err, db) => {
    const query = 'INSERT INTO classes (name) VALUES("SD22w");';
...
const addCourse = () => new Promise((resolve, reject) => {
  pool.getConnection((err, db) => {
    const query = 'INSERT INTO courses (name) VALUES("Development of Large Systems");';
...
const addLecture = (teacherId, courseId, classId) => {
  ...
  return new Promise((resolve, reject) => {
    pool.getConnection((err, db) => {
      const query = 'INSERT INTO lectures (teacher_id, start_date_time, course_id, class_id) '
...
const addAttendance = (studentId, lectureId) => new Promise((resolve, reject) => {
  pool.getConnection((err, db) => {
